...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head><link rel="stylesheet" href="./colony.css" /><link rel="stylesheet" href="./environment.css" /><link rel="stylesheet" href="./battle.css" /><link rel="stylesheet" href="./tutorial.css" /></head>
